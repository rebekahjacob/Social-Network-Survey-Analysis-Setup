...
color_pal= c("#15d4f7", "#f96e26")
  plot(x, edge.color="Light Gray", vertex.label.cex=0.5, vertex.label.dist=1, vertex.color=V(x)$position_color, vertex.frame.color=NA, vertex.size=rescale_fun(degree(x), 5, 15), layout=layout_components, main=y)
...
color_pal= c("#f96e26", "#15d4f7", "#5e53f7")
  plot(x, edge.color="Light Gray", vertex.label.cex=0.5, vertex.label.dist=1, vertex.color=V(x)$location_color, vertex.frame.color=NA, vertex.size=rescale_fun(degree(x), 5, 15), layout=layout_components, main=y)
